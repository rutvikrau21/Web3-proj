...
declare type QueryConfig<TData, TError, TSelectData = TData> = Pick<UseQueryOptions<TData, TError, TSelectData>, 'cacheTime' | 'enabled' | 'isDataEqual' | 'keepPreviousData' | 'select' | 'staleTime' | 'structuralSharing' | 'suspense' | 'onError' | 'onSettled' | 'onSuccess'> & {
    /** Scope the cache to a given context. */
    scopeKey?: string;
};
declare type InfiniteQueryConfig<TData, TError, TSelectData = TData> = Pick<UseInfiniteQueryOptions<TData, TError, TSelectData>, 'cacheTime' | 'enabled' | 'getNextPageParam' | 'isDataEqual' | 'keepPreviousData' | 'select' | 'staleTime' | 'structuralSharing' | 'suspense' | 'onError' | 'onSettled' | 'onSuccess'> & {
    /** Scope the cache to a given context. */
    scopeKey?: string;
};
...
declare type UseContractInfiniteReadsConfig<TContracts extends unknown[] = unknown[], TPageParam = unknown, TSelectData = ReadContractsResult<TContracts>> = Pick<ReadContractsConfig<TContracts>, 'allowFailure' | 'overrides'> & {
    cacheKey: string;
...
declare type UseContractReadConfig<TAbi = Abi, TFunctionName = string, TSelectData = ReadContractResult<TAbi, TFunctionName>> = ReadContractConfig<TAbi, TFunctionName, {
    isAbiOptional: true;
...
declare type UseContractReadsConfig<TContracts extends unknown[], TSelectData = ReadContractsResult<TContracts>> = ReadContractsConfig<TContracts, {
    isAbiOptional: true;
    isAddressOptional: true;
    isArgsOptional: true;
